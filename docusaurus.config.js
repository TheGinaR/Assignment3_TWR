      ...
      ({
        ...
        sitemap: {
              ...
              createSitemapItems: async (params) => {
                  ...
                  return items.filter((item) => !item.url.includes('/pages/'));
              },
          },
      }),
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {to: 'contact_information', label: 'Contact', position: 'left'},
          {
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} My Assignment 3, Inc. Built with Docusaurus.`,
      },
      prism: {
